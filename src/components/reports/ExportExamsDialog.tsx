...
export function ExportExamsDialog({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            let filename = format === "excel" ? `${cleanTitle}${classNameSuffix}.xlsx` : `${cleanTitle}${classNameSuffix}.pdf`;
            ...
            toast.success("تم تحميل الدرجات بنجاح");
            onOpenChange(false);
        } catch (error: any) {
            console.error("Export failed", error);

            let errorMessage = "فشل تحميل الدرجات. يرجى المحاولة مرة أخرى.";
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle>تحميل درجات الاختبار</DialogTitle>
                    <DialogDescription>
                        اختر الاختبار والفصل الذي تريد تحميل درجات طلابه بصيغة Excel أو PDF
                    </DialogDescription>
                </DialogHeader>
