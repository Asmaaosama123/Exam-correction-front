...
export default function Home() {
  ...
  if (isAuthenticated) {
    const isAdmin = user.roles?.includes("Admin") || user.email === 'superadmin@wsyli.com' || user.email === 'admin@exam-correction.com';
    const redirectUrl = isAdmin ? "/admin" : "/dashboard";
    const redirectText = isAdmin ? "الذهاب إلى الإدارة" : "الذهاب إلى لوحة التحكم";
